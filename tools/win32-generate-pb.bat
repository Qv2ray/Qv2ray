...
%~dp0\..\libs\x86-windows\tools\protobuf\protoc.exe v2ray_api.proto --cpp_out=%~dp0..\libs\gen
if errorlevel 1 goto errored

echo. ---^> Generating geosite proto file.
%~dp0\..\libs\x86-windows\tools\protobuf\protoc.exe v2ray_geosite.proto --cpp_out=%~dp0..\libs\gen
if errorlevel 1 goto errored
