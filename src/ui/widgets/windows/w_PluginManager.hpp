    ...
    , private Ui::w_PluginManager
{
  ...
  private:
    ...
    std::shared_ptr<Qv2rayPlugin::PluginSettingsWidget> currentSettingsWidget;
    const Qv2ray::components::plugins::QvPluginInfo *currentPluginInfo;
    QHash<QString, const QvPluginInfo *> plugins;
    bool isLoading = true;
};
