#include "V2Ray5ProfileGenerator.hpp"
...
V2Ray5ProfileGenerator::V2Ray5ProfileGenerator(const ProfileContent &profile) : profile(profile){};

QByteArray V2Ray5ProfileGenerator::GenerateConfiguration(const ProfileContent &p)
{
    return V2Ray5ProfileGenerator(p).Generate();
}

QByteArray V2Ray5ProfileGenerator::Generate()
{
...
void V2Ray5ProfileGenerator::ProcessRoutingRule(const RuleObject &r)
{
    QJsonObject rule;
...
void V2Ray5ProfileGenerator::ProcessInboundConfig(const InboundObject &in)
{
    QJsonObject root;
...
void V2Ray5ProfileGenerator::ProcessOutboundConfig(const OutboundObject &out)
{
...
void V2Ray5ProfileGenerator::ProcessBalancerConfig(const OutboundObject &out)
{
...
QJsonObject V2Ray5ProfileGenerator::GenerateStreamSettings(const IOStreamSettings &stream)
{
    return stream;
}
