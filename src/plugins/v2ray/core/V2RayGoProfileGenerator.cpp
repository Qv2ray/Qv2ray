...
QByteArray V2RayGoProfileGenerator::GenerateConfiguration(const ProfileContent &profile)
{
...
void V2RayGoProfileGenerator::GenerateDNSConfig(const QJsonObject &_dns, google::protobuf::Any *app)
{
...
void V2RayGoProfileGenerator::GenerateStreamSettings(const IOStreamSettings &s, ::v2ray::core::transport::internet::StreamConfig *vs)
{
...
void V2RayGoProfileGenerator::GenerateInboundConfig(const InboundObject &in, ::v2ray::core::InboundHandlerConfig *vin)
{
    // inbound.tag
...
void V2RayGoProfileGenerator::GenerateOutboundConfig(const OutboundObject &out, v2ray::core::OutboundHandlerConfig *vout)
{
